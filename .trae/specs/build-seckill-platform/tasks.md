...
- [ ] Task 1.1: 初始化 Maven 项目骨架
  ...
  - 验证：`mvn compile` 通过
- [ ] Task 1.2: 编写 application.yml 多环境配置
...
- [ ] Task 2.2: 实现实体类与 MyBatis-Plus 配置
...
- [ ] Task 3.1: 实现 JWT 工具与 Token 管理
  ...
  - 验证：Token 生成解析单测通过
- [ ] Task 3.2: 实现 Spring Security 配置与过滤器
...
## M5 秒杀核心模块（P0）
- [ ] Task 5.1: 实现 Redis 缓存服务与 Key 管理
...
- [ ] Task 6.4: 实现订单 Controller 与支付接口
