...
import com.seckill.mall.payment.infrastructure.mapper.RechargeCardMapper;
...
public class RechargeCardServiceImpl implements RechargeCardService {
    ...
    public BigDecimal recharge(String cardNo, String cardPassword, Long userId) {
        ...
        // 用户余额 += 面额（Phase 15：委托 UserApi.addBalance，删除 LambdaUpdateWrapper 构建）
        userApi.addBalance(userId, card.getFaceValue());
        // 查询最新余额
